...
xg_model_0 = joblib.load(path_models + 'Dokkodo_H1_buy_xg_model_v3_std.sav')
lg_model_1 = joblib.load(path_models + 'Dokkodo_H1_buy_lg_model_v3_std.sav')

#load metamodel
best_meta_model = joblib.load(path_models + 'Dokkodo_H1_buy_meta_model_v3_std.sav')
...
decision_dataset_buy.to_csv(path_decision + 'decision_dataset_buy_dokkodo.csv', index=False)

#print head
print('Buy predictions',decision_dataset_buy.head())